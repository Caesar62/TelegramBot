...
from sartools.cj3 import patterns
...
def pattern_sdr(message):
	chatid = message.chat.id
	nombreUsuario = message.chat.first_name + " " + message.chat.last_name
	print("Ha activado el bot (PATTERN): ",nombreUsuario)
	texto_devolver2 = patterns()
	bot.send_message(chatid,texto_devolver2)
	#print(texto_devolver2)
